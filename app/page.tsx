...
export default function Home(){
  ...
  return <main className="app-shell">
    ...
    <div className="page" id="top">
      <section className="intro"><div><p className="eyebrow">Your mutuals. Your best shot.</p><h1>Find the people who can still <em>vouch for you.</em></h1><p className="lede">Scan your X mutuals, see who joined Commons, and reach out before their vouches run out.</p></div><div className="intro-side"><div className="deadline-card"><span>Campaign window</span><strong>Ending soon</strong><p>Don’t leave good mutuals unasked.</p></div><a className="support-builder" href={`https://x.com/intent/post?text=${encodeURIComponent("Hey @commonsmade vouch, @MojeebMotion (Support the Builder with Vouch ❤️)")}`} target="_blank" rel="noreferrer"><span>Support the builder ❤️</span><strong>Vouch for @MojeebMotion</strong><small>Post on X ↗</small></a></div></section>
    ...
    <footer><span>Built for people holding each other down.</span><span>Built by <a href="https://x.com/MojeebMotion" target="_blank" rel="noreferrer">Mojeeb (@MojeebMotion)</a></span></footer>
  </main>
}
